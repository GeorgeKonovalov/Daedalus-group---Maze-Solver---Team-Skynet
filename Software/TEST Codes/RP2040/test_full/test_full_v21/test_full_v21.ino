...
void handlePIDInput(int delta, ButtonEvent btn) {
  ...
  if (btn == ButtonEvent::ShortPress) {
    switch (pidIndex) {
      ...
      case 5: openDigitEditor("L Corr", &workingSettings.pidLeftScale_x100, 10, 300); break;
      case 6: openDigitEditor("R Corr", &workingSettings.pidRightScale_x100, 10, 300); break;
      case 7:
...
void drawPIDScreen() {
  ...
  items[5] = "L Corr: " + formatX100(workingSettings.pidLeftScale_x100);
  items[6] = "R Corr: " + formatX100(workingSettings.pidRightScale_x100);
  items[7] = "PID Test";
  items[8] = "Back";
